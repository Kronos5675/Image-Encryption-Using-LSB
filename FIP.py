...
if page == "Home":
    ...
    st.write("With this Application, you can encode messages into your project that only you can access via specialized access code generated by the program")
    ...
    st.title("Happy Crypting!",center)
elif page == "Encode":
